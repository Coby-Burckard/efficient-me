...
function buildGoal(goal) {
  ...
  */
  ...
  TAandGoalContainer.classList.add('ta-goal-container'); //adding event listeners

  deleteButton.addEventListener('click', handleDeleteRequest); //adding goal details to respective elements
